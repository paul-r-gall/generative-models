""" A Variational Autoencoder with an Adversarial loss function
lovingly duplicated from https://github.com/wiseodd/generative-models
"""
...
if not os.path.exists('vae-gan-out/'):
    os.makedirs('vae-gan-out/')
...
for it in range(1000000):
    ...
    if it % 2000 == 0:
        ...
        fig = plot(samples)
        plt.savefig('vae-gan-out/{}.png'.format(str(i).zfill(3)), bbox_inches='tight')
        i += 1
        plt.close(fig)
